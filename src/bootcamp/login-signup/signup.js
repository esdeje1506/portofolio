            ...
            <div className="mt-16 w-vw p-1">
                <div className="mx-auto h-auto w-4/12 min-w-64 rounded-lg border bg-white p-2.5 font-sans shadow-lg">
                    ...
                    <form>
                        ...
                        <input placeholder="Nama Lengkap" className="mx-0 my-2.5 h-10 w-full rounded-2xl border bg-slate-200 px-2.5" />
                        ...
                        <label for="psw" className="text-sm ml-2.5">Show password</label>
                        <div className="mt-2.5 flex w-full justify-between text-sm font-bold">
                            ...
                            <Link to="..\login"><span className="no-underline">Punya Akun?</span></Link>

                        </div>
                        <button className="mx-0 my-2.5 h-10 w-full rounded-2xl border bg-green-300 px-2.5 font-medium hover:bg-green-500">Sign-Up</button>
                    </form>
                </div>
